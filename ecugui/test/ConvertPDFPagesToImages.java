...
public class ConvertPDFPagesToImages {
    public static void main(String[] args) {
        try {
            String sourceDir = "/home/lg/AAA/factura-oxxo2.pdf"; // Pdf files are read from this folder
            String destinationDir = "/home/lg/AAA/jpg/"; // converted images from pdf document are saved here
