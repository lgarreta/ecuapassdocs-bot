...
public class EcuapassViewCartaporte extends EcuapassView {
	public EcuapassViewCartaporte () {
		...
		Dimension size = new Dimension (960, 1310);
	...
	public ArrayList <Component> getInputTextFields () {
		...
		JScrollPane txt79 = new JScrollPane (new JTextArea (2,40));imagePanel.add (txt79);txt79.setBounds (202, 1206, 762, 46);
