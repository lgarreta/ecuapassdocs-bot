...
class EcuBotCartaporte (EcuBot):
	...
	def fillEcuapass (self):
		...
		self.fillBoxCheck ("05_TipoProcedimiento", "TABCHECK")
		#self.fillBoxCheck ("06_EmpresaTransporte") # Selected by default
		py.press ("Tab")
		self.fillBoxCheck ("07_DepositoMercancia")
